...
public class ConcursoTest {
    ...
    @Test
    public void inscripcionDentroRango() throws Exception {
    ...
    @Test
    public void inscripcionEnPrimerDia() throws Exception {
    ...
    @Test
    public void inscripcionFueraDeRango() throws Exception {
